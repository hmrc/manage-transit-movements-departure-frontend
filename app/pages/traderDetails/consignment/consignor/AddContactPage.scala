...
import pages.sections.traderDetails.{TraderDetailsConsignorContactSection, TraderDetailsConsignorSection}
...
case object AddContactPage extends QuestionPage[Boolean] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(controllers.traderDetails.consignment.consignor.routes.AddContactController.onPageLoad(userAnswers.lrn, mode))
}
