...
import pages.sections.EquipmentsSection
import play.api.libs.json.JsPath
import play.api.mvc.Call

case object RemoveTransportEquipmentPage extends QuestionPage[Boolean] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.RemoveTransportEquipmentController.onPageLoad(userAnswers.lrn, mode))
}
