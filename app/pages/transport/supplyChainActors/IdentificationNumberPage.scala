...
case class IdentificationNumberPage(actorIndex: Index) extends QuestionPage[String] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.IdentificationNumberController.onPageLoad(userAnswers.lrn, mode, actorIndex))
}
