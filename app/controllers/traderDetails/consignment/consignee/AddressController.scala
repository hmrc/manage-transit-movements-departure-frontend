...
class AddressController @Inject() (
  ...
  private def form(isPostalCodeRequired: Boolean)(implicit request: Request): Form[DynamicAddress] =
    formProvider("traderDetails.consignment.consignee.address", isPostalCodeRequired, name)
            ...
            form(isPostalCodeRequired)
              ...
              .fold(
                ...
                value => {
                  ...
                  AddressPage.writeToUserAnswers(value).updateTask[TraderDetailsDomain]().writeToSession().navigate()
                }
              )
        }
    }
