...
import pages.traderDetails.consignment.consignor.AddContactPage
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            AddContactPage.writeToUserAnswers(value).updateTask[TraderDetailsDomain]().writeToSession().navigate()
          }
        )
  }
}
