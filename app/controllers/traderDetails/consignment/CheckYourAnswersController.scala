...
import viewModels.traderDetails.TraderDetailsConsignmentViewModel.TraderDetailsConsignmentSubSectionViewModel
import views.html.traderDetails.consignment.CheckYourAnswersView
...
class CheckYourAnswersController @Inject() (
  ...
  viewModel: TraderDetailsConsignmentSubSectionViewModel
