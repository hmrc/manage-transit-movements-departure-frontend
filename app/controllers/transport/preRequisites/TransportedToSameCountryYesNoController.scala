...
class TransportedToSameCountryYesNoController @Inject() (
  ...
  def onPageLoad(lrn: LocalReferenceNumber, mode: Mode): Action[AnyContent] = actions.requireData(lrn) {
    implicit request =>
      val preparedForm = request.userAnswers.get(TransportedToSameCountryYesNoPage) match {
        case None        => form
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            TransportedToSameCountryYesNoPage.writeToUserAnswers(value).updateTask[TransportDomain]().writeToSession().navigate()
          }
        )
  }
}
