...
class AddGoodsItemNumberForContainerController @Inject() (
        ...
        form
          ...
          .fold(
            ...
            value => {
              ...
              AddGoodsItemNumberForContainerPage(equipmentIndex).writeToUserAnswers(value).updateTask[TransportDomain]().writeToSession().navigate()
            }
          )
    }
}
