...
import pages.test.Test1Page
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.SessionRepository
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.test.Test1View

import javax.inject.Inject
import scala.concurrent.{ExecutionContext, Future}

class Test1Controller @Inject() (
  ...
  private val form = formProvider("test.test1")
  ...
  def onPageLoad(lrn: LocalReferenceNumber, mode: Mode, fooIndex: Index, barIndex: Index): Action[AnyContent] = actions.requireData(lrn) {
    implicit request =>
      val preparedForm = request.userAnswers.get(Test1Page(fooIndex, barIndex)) match {
        case None        => form
      ...
      form
        ...
        .fold(
          ...
          value => {
            ...
            Test1Page(fooIndex, barIndex).writeToUserAnswers(value).writeToSession().navigateWith(mode)
          }
        )
  }
}
