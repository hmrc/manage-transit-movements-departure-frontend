...
class EoriYesNoViewSpec extends YesNoViewBehaviours {
  ...
  behave like pageWithContent(
    "p",
    "The transit holder is the person responsible for the transit procedure. Their guarantee will be held against the movement until it reaches its destination. They can submit the declaration themselves or a third party can do it on their behalf."
  )
