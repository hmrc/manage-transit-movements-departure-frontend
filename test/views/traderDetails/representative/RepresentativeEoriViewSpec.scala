...
class RepresentativeEoriViewSpec extends InputTextViewBehaviours[String] {
  ...
  override def applyView(form: Form[String]): HtmlFormat.Appendable =
    injector.instanceOf[RepresentativeEoriView].apply(form, lrn, NormalMode)(fakeRequest, messages)
