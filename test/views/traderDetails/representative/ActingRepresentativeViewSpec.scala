...
class ActingRepresentativeViewSpec extends YesNoViewBehaviours {

  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[ActingRepresentativeView].apply(form, lrn, NormalMode)(fakeRequest, messages)
