...
class RepresentativeNameViewSpec extends InputTextViewBehaviours[String] {
  ...
  override def applyView(form: Form[String]): HtmlFormat.Appendable =
    injector.instanceOf[RepresentativeNameView].apply(form, lrn, NormalMode)(fakeRequest, messages)
