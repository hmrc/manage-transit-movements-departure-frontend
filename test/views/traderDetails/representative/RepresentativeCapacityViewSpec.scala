...
class RepresentativeCapacityViewSpec extends RadioViewBehaviours[RepresentativeCapacity] {
  ...
  override def applyView(form: Form[RepresentativeCapacity]): HtmlFormat.Appendable =
    injector.instanceOf[RepresentativeCapacityView].apply(form, lrn, RepresentativeCapacity.radioItems, NormalMode)(fakeRequest, messages)
