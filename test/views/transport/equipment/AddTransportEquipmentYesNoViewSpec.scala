...
class AddTransportEquipmentYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AddTransportEquipmentYesNoView].apply(form, lrn, NormalMode)(fakeRequest, messages)

  override val prefix: String = "transport.equipment.addTransportEquipmentYesNo"
