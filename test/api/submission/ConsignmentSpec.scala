...
import models.journeyDomain.transport.transportMeans.TransportMeansDomainWithOtherInlandMode

class ConsignmentSpec extends SpecBase with UserAnswersSpecHelper with Generators {

  val arbitraryDepartureUserAnswers: UserAnswers = arbitraryDepartureAnswers(emptyUserAnswers).sample.value
