...
import pages.transport.transportMeans.departure.MeansIdentificationNumberPage
...
class MeansIdentificationNumberControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  private val form         = formProvider("transport.transportMeans.departure.meansIdentificationNumber")
  ...
  "MeansIdentificationNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(MeansIdentificationNumberPage, "test string")
