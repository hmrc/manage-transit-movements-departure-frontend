...
import pages.routeDetails.locationOfGoods.AdditionalIdentifierPage
import play.api.inject.bind
import play.api.inject.guice.GuiceApplicationBuilder
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.routeDetails.locationOfGoods.AdditionalIdentifierView
...
class AdditionalIdentifierControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  private val form                           = formProvider("routeDetails.locationOfGoods.additionalIdentifier")
  private val mode                           = NormalMode
  private lazy val additionalIdentifierRoute = routes.AdditionalIdentifierController.onPageLoad(lrn, mode).url
  ...
  "AdditionalIdentifier Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AdditionalIdentifierPage, "test")
