...
import views.html.traderDetails.consignment.consignee.EoriYesNoView
...
class EoriYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  private val form                = formProvider("traderDetails.consignment.consignee.eoriYesNo")
  private val mode                = NormalMode
  private lazy val eoriYesNoRoute = routes.EoriYesNoController.onPageLoad(lrn, mode).url
  ...
  "EoriYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, eoriYesNoRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, eoriYesNoRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, eoriYesNoRoute).withFormUrlEncodedBody(("value", ""))
