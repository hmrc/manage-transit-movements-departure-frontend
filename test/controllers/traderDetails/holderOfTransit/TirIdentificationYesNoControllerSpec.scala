...
class TirIdentificationYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {

  private val formProvider                     = new YesNoFormProvider()
  private val form                             = formProvider("traderDetails.holderOfTransit.tirIdentificationYesNo")
  private val mode                             = NormalMode
  private lazy val tirIdentificationYesNoRoute = routes.TirIdentificationYesNoController.onPageLoad(lrn, mode).url
  ...
  "traderDetails.holderOfTransit.TirIdentificationYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[TirIdentificationYesNoView]
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, tirIdentificationYesNoRoute).withFormUrlEncodedBody(("value", ""))
