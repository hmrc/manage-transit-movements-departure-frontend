...
class ExitNavigatorSpec extends SpecBase with ScalaCheckPropertyChecks with Generators with RouteDetailsUserAnswersGenerator {

  private val navigator = new ExitNavigator(ctcCountryCodes, customsSecurityAgreementAreaCountryCodes)
  ...
  "Exit Navigator Provider" - {
    ...
    "must retrieve reference data lists" in {
      ...
      val provider = new ExitNavigatorProviderImpl(mockService)
