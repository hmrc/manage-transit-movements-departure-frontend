...
package models.routeDetails.locationOfGoods
...
class LocationOfGoodsTypeSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {
