...
class RouteDetailsDomainSpec extends SpecBase with UserAnswersSpecHelper with Generators {
  ...
  "RouteDetailsDomain" - {
    ...
    "can be parsed from UserAnswers" - {
      ...
      "when a TIR declaration" in {
        ...
        val result: EitherType[RouteDetailsDomain] = UserAnswersReader[RouteDetailsDomain].run(userAnswers)
