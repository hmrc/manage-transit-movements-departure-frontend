...
class SupplyChainActorTypePageSpec extends PageBehaviours {
  ...
  "SupplyChainActorTypePage" - {
    ...
    beRetrievable[SupplyChainActorType](SupplyChainActorTypePage)

    beSettable[SupplyChainActorType](SupplyChainActorTypePage)

    beRemovable[SupplyChainActorType](SupplyChainActorTypePage)
  }
}
