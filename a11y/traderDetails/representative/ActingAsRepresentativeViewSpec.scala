...
class ActingAsRepresentativeViewSpec extends A11ySpecBase with Generators {

  "the 'acting as representative' view" must {
    val view = app.injector.instanceOf[ActingAsRepresentativeView]
