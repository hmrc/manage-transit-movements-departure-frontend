...
echo "GET        /:lrn/$package;format="word-space,normalize"$/$className;format="decap"$                        controllers.$package$.$className$Controller.onPageLoad(lrn: LocalReferenceNumber)" >> ../conf/app.routes
